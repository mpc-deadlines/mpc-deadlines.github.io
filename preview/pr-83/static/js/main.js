$(function() {
  ...
  var rawDeadlines = ["2026-08-26 00:00","2026-09-14 00:00"] || [];
  if (rawDeadlines.constructor !== Array) {
    rawDeadlines = [rawDeadlines];
  }
  var parsedDeadlines = [];
  ...
  if (deadlineId < parsedDeadlines.length) {
    ...
    if (confDeadline) {
      ...
      $('#wpec2026-theory-pract-applied-ppml-sok-wk-0 .timer').countdown(confDeadline.toDate(), make_update_countdown_fn(confDeadline));
      // check if date has passed, add 'past' class to it
      if (moment() - confDeadline > 0) {
        $('#wpec2026-theory-pract-applied-ppml-sok-wk-0').addClass('past');
      }
      $('#wpec2026-theory-pract-applied-ppml-sok-wk-0 .deadline-time').html(confDeadline.local().format('D MMM YYYY, h:mm:ss a'));
      deadlineByConf["wpec2026-theory-pract-applied-ppml-sok-wk-0"] = confDeadline;
    }
  } else {
    // TODO: hide the conf_id ?
  }
  ...
  if (deadlineId < parsedDeadlines.length) {
    ...
    if (confDeadline) {
      ...
      $('#wpec2026-theory-pract-applied-ppml-sok-wk-1 .timer').countdown(confDeadline.toDate(), make_update_countdown_fn(confDeadline));
      // check if date has passed, add 'past' class to it
      if (moment() - confDeadline > 0) {
        $('#wpec2026-theory-pract-applied-ppml-sok-wk-1').addClass('past');
      }
      $('#wpec2026-theory-pract-applied-ppml-sok-wk-1 .deadline-time').html(confDeadline.local().format('D MMM YYYY, h:mm:ss a'));
      deadlineByConf["wpec2026-theory-pract-applied-ppml-sok-wk-1"] = confDeadline;
    }
  } else {
    // TODO: hide the conf_id ?
  }
