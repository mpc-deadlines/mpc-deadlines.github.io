$(function() {
  ...
  if (deadlineId < parsedDeadlines.length) {
    ...
    if (confDeadline) {
      ...
      $('#space2026-theory-pract-applied-cnf-coreb-0 .timer').countdown(confDeadline.toDate(), make_update_countdown_fn(confDeadline));
      // check if date has passed, add 'past' class to it
      if (moment() - confDeadline > 0) {
        $('#space2026-theory-pract-applied-cnf-coreb-0').addClass('past');
      }
      $('#space2026-theory-pract-applied-cnf-coreb-0 .deadline-time').html(confDeadline.local().format('D MMM YYYY, h:mm:ss a'));
      deadlineByConf["space2026-theory-pract-applied-cnf-coreb-0"] = confDeadline;
    }
  } else {
    // TODO: hide the conf_id ?
  }
  ...
  if (deadlineId < parsedDeadlines.length) {
    ...
    if (confDeadline) {
      ...
      $('#space2026-theory-pract-applied-cnf-coreb-1 .timer').countdown(confDeadline.toDate(), make_update_countdown_fn(confDeadline));
      // check if date has passed, add 'past' class to it
      if (moment() - confDeadline > 0) {
        $('#space2026-theory-pract-applied-cnf-coreb-1').addClass('past');
      }
      $('#space2026-theory-pract-applied-cnf-coreb-1 .deadline-time').html(confDeadline.local().format('D MMM YYYY, h:mm:ss a'));
      deadlineByConf["space2026-theory-pract-applied-cnf-coreb-1"] = confDeadline;
    }
  } else {
    // TODO: hide the conf_id ?
  }
